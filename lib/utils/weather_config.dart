...
class WeatherConfig {
  ...
  static const String weatherApiEndpoint = 'https://api.openweathermap.org/data/2.5/weather';
  ...
  static const String weatherApiKey = String.fromEnvironment('OPENWEATHER_API_KEY', defaultValue: '');
  
  // Aurora Province coordinates (central point)
  static const double auroraLat = 15.8333; // Approximate center of Aurora Province
